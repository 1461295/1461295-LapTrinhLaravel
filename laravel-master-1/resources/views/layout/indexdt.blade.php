...
@section('section')
    <div id="section">
        <ul>
            ...
            <li><a href="/Loai/{{$item->MaLoai}}">{{$item->TenLoai}}</a></li>
            @endforeach
        </ul>
...
@section('content')
    <div class="home">
        ...
        <div class="section">
            ...
            <ul>
                <li class="first">
                    <a href="/"><img src="images/cake.jpg" alt="Image" /></a>
                </li>
                <li>
                    <a href="/"><img src="images/burgercake.jpg" alt="Image" /></a>
                </li>
                <li>
                    <a href="/"><img src="images/cupcake.jpg" alt="Image" /></a>
                </li>
            </ul>
        </div>
    </div>
